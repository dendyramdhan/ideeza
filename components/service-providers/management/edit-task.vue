            ...
            <div class="p-20 mt-10 flex">
                ...
                <div class="lg:ml-20">
                    <div class="flex items-center">
                        ...
                        <!--Calendar-->
                        <vc-date-picker v-model="dateRange" color="pink" mode='range' value="" :popover="{ placement: 'bottom', visibility: 'click' }">
                    ...
                    <div class="mt-10">
                        Notification center:
                        <button @click.self="showNotifications = true" class="ml-5 btn btn-small btn--ideeza px-2 text-xs">Compose
                            <font-awesome-icon class="ml-2 h-3 text-white" :icon="['fas', 'paper-plane']" /></button>
                    </div>
                    <div class="mt-10">
                        <div class="flex">
                            <div class="mr-2">
