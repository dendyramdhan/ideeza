  ...
  <div class="bg-white h-full shadow relative left-side-bar">
    ...
    <div class="relative w-full" v-if="activeMenu === 'messages'">
      ...
      <div class="flex justify-center mb-5">
        <div @click="activeMessages = 'people'" class="messages-left-toggler" :class="{'active': activeMessages === 'people'}" >Users</div>
        <div @click="activeMessages = 'groups'" class="messages-left-toggler" :class="{'active': activeMessages === 'groups'}">Service Providers</div>
        <div @click="activeMessages = 'unseen'" class="messages-left-toggler" :class="{'active': activeMessages === 'unseen'}">Investors</div>
      </div>
      <!--Left Menu-->
...
<script>
  import CommonMenu from '~/components/admin/menu-items.vue'
    export default {
