  ...
  <div @click.self="close" class="popup-overlay">
    <div class="popup-overlay--contents add-new-container" @click.stop>
      ...
      <div class="flex justify-between border-b border-ideeza">
        <input
          type="text"
          class="outline-none border-0 text-ideeza text-2xl placeholder-ideeza lg:w-1/2"
      ...
      <div class="mt-10 flex flex-wrap popup-body">
        <div class="lg:w-1/2">
          ...
          <div class="mt-5">
            <textarea v-if="project.edit==true"
                placeholder="Edit project description here ...." v-model="project.description" style="width:100%;height:150px;"
            ></textarea>
        ...
        <div class="lg:ml-20 flex-1 pr-20">
          <div class="flex items-center">
            ...
            <vc-date-picker
              ...
              color="pink"
              mode="range"
              :value="[new Date(parseInt(project.start,10)),new Date(parseInt(project.end,10))]"
