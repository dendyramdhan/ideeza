<template>
  <div class="popup-overlay z-50">
    <div class="popup-overlay--contents add-new-container" v-click-outside="close">
      <div class="main-contents" v-if="info">
        <div class="mt-10">
          <div class="flex justify-between items-center border-b-4 border-solid border-ideeza pb-5">
            <div class="flex">
              ...
              <span class="font-semibold">Shipping address: <span class="font-normal">{{info.address}}</span></span>
                ...
                <tr class="bg-ideeza-100">
                  ...
                  <td class="text-center">
                    <div class="text-sm text-gray-600 w-3/4 bg-white h-8 text-center rounded-full relative">
                      ...
                      <div class="bg-ideeza rounded-full h-8"
                        :style="{ width: ((task.end - task.start)/100000000) +'%'}"></div>
                    </div>
                  </td>
                  <td>{{task.status}}</td>
          ...
          <detail-task @onClose="detailTask=false" @onEdit="detailTask=false;editTask=true" v-if="detailTask"
            @complete="detailTask=false;completeTask=true" :parentData="sendparentdata" />
...
<script>
  ...
  export default {
    ...
    created: function () {
      this.info = this.Servicestask.find(item => item.id == this.id);
    },
  }
...
<style scoped>
  .popup-overlay--contents.add-new-container{
      width:80vw;
  }
  .project-description {
    width: 100%;
