<template>
    <div class="p-5">
        <h5 class="font-semibold text-lg text-center mt-2">List Picker</h5>
        <div class="mt-5 mx-3">
            <div>Background Color</div>
            <div class="rounded p-4 text-white bg-green-300 mt-1">#FFFFFF
            </div>
        </div>
        <check-box class="mx-3 mt-3">Enabled</check-box>
        ...
        <li class="mb-3">
          ...
          <div class="mt-1">
              ...
              <div class="flex items-center">
                ...
                <div class="flex flex-1 justify-between text-xl">
                    <div class="flex-1"><u>U</u></div>
                    <div class="flex-1"><b>B</b></div>
                    <div class="flex-1"><i>I</i></div>
                </div>
              </div>
          </div>
          <div class="mt-3 text-sm">
          ...
          <div class="mt-1">
              <input type="text" class="w-full border p-2" placeholder="No file choosen">
          </div>
          <div class="mt-3 text-sm">
          ...
          <check-box class="ml-1 mt-2">Show feedback</check-box>
          <check-box class="ml-1 mt-2">Show filter bar</check-box>
          <div class="mt-3 text-sm">
              Text
          </div>
          <div class="mt-1">
