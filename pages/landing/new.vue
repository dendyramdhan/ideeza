    ...
    <div class="md:flex sm:block">
      <div class="md:w-6/12 sm:w-full px-3">
        ...
        <p class="text-gray-700 text-2xl font-bold py-5 bg-i">
        	<nuxt-link to="" class="text-white py-2 btn-md bg-ideeza inline-block text-center text-lg rounded-full">Try Free</nuxt-link>
        </p>
      </div>
...
<div class="w-full relative py-6 mt-20">
    ...
    <div class="md:flex sm:block justify-end">
      ...
      <div class="md:w-6/12 sm:w-full pt-10 ">
        ...
        <p class="text-gray-700 text-2xl font-bold py-5 bg-i">
          <nuxt-link to="" class="text-white py-2 btn-md bg-ideeza inline-block text-center text-lg rounded-full">Read More</nuxt-link>
        </p>
      </div>
    </div>
</div>
...
From our many and diverse projects you can easily find your way to success and rapid growth. </p>
        <p class="text-gray-700 text-2xl font-bold py-5 bg-i">
          <nuxt-link to="" class="text-white py-2 btn-md bg-ideeza inline-block text-center text-lg rounded-full">Contact Us</nuxt-link>
        </p>
