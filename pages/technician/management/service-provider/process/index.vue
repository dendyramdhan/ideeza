  ...
  <div class="flex main-panel">
    ...
    <div class="flex-grow">
      <div class="main-contents">
        <h1 class="text-indigo-800 font-bold text-2xl border-b-4 border-solid border-ideeza pb-5 mt-8">Process</h1>
        <div class="flex py-2">
        ...
        <div class="bg-white rounded p-3">
          <table cellpadding="0" cellspacing="0" width="100%" class="text-left">
            ...
            <tr class="bg-gray-200">
              <td class="px-2 py-3">3D Printing - Additive</td>
              <td class="px-2 py-3">Binder jetting - BJ - added,<br> Powder bed fusion - DMLS,<br> SLS, SLM, MJF, EBM</td>
