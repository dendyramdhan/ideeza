<template>
  <div class="flex main-panel">
      ...
      <div class="main-contents">
        ...
        <div class="flex py-2">
          ...
          <div class="w-1/2 flex justify-end">
            <button @click="showAddCorporation = true;" class="bg-ideeza border text-white rounded px-3 py-1">
              Add new corp
            </button>
    ...
    <AddCorporation v-if="showAddCorporation" @close="showAddCorporation=false" />
  </div>
</template>
<script>
import AddCorporation from "~/components/technician/management/service-provider/AddCorporation";
