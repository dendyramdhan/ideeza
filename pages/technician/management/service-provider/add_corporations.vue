  ...
  <div :class="{'hide-left-bar':!leftMenu}" class="flex main-panel">
    ...
    <div class="flex-grow">
      <div class="main-contents">
        <h1 class="text-indigo-800 font-bold text-2xl border-b-4 border-solid border-ideeza pb-5 mt-8">Corporations</h1>
      ...
      <div class="bg-white rounded p-3">
        <table cellpadding="0" cellspacing="0" width="100%" class="text-left">
          <tr class="">
            <th class="text-gray-600 py-3 px-2" width="25%">
              Title <font-awesome-icon
                  class="mr-1 text-lg text-black"
                  :icon="['fas', 'sort']"
                />
            </th>
            <th class="text-gray-600 py-3 px-2" width="55%">
              Icon <font-awesome-icon
                  class="mr-1 text-lg text-black"
                  :icon="['fas', 'sort']"
                />
            </th>
            <th class="text-gray-600 py-3 px-2 text-right" width="20%">
              <font-awesome-icon
                  class="mr-1 text-lg text-black"
                  :icon="['fas', 'ellipsis-h']"
                />
          ...
          <tr class="bg-gray-200">
            <td class="px-2 py-4">Google</td>
            <td class="px-2 py-4"><img src="~/static/images/corp_ref_1226.png"></td>
    ...
    <div class="w-4/12 p-4 m-auto bg-white border border-gray-600 shadow fixed z-50 top-0 left-0 right-0 m-auto mt-32">
        <h2 class="text-indigo-800 font-bold text-2xl pb-5 mt-8">Add corporation</h2>
        <div class="mb-4">
          <input class="shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="" type="text" placeholder="Corporation name">
        </div>
