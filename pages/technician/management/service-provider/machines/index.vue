<template>
  <div class="flex main-panel">
      ...
      <div class="main-contents">
        ...
        <div class="flex py-2">
          ...
          <div class="w-1/2 flex justify-end">
            <button @click="addNewMachine" class="bg-ideeza border text-white rounded px-3 py-1">
              Create new machine
            </button>
        ...
        <div class="bg-white rounded p-3">
          <table cellpadding="0" cellspacing="0" width="100%" class="text-left">
            ...
            <tr class="bg-gray-200">
              <td @click="showMachineDetails = true;" class="px-2 py-3">Flame reducers for military</td>
    ...
    <MachineDetails v-if="showMachineDetails" @close="showMachineDetails=false" />
  </div>
</template>
<script>
import MachineDetails from "~/components/technician/management/service-provider/MachineDetails";
...
export default {
  ...
  methods: {
    addNewMachine() {
      this.$router.push('/technician/management/service-provider/machines/add');
    },
    search(e) {
      this.articleArray = [];
