<template>
  <div class="flex main-panel">
      ...
      <div class="main-contents">
        ...
        <div class="flex py-2">
          ...
          <div class="w-1/2 flex justify-end">
            <button @click="showAddCertifications = true;" class="bg-ideeza border text-white rounded px-3 py-1">
              Add new cert
            </button>
        ...
        <div class="bg-white rounded p-3">
          <table cellpadding="0" cellspacing="0" width="100%" class="text-left">
            <tr class="">
              ...
              <th class="text-gray-600 py-3 px-2">
                <font-awesome-icon class="mr-1 text-lg text-black" :icon="['fas', 'sort']" /> Estabilishment
              </th>
    ...
    <AddCertifications v-if="showAddCertifications" @close="showAddCertifications=false" />
  </div>
</template>
<script>
import AddCertifications from "~/components/technician/management/service-provider/AddCertifications";
