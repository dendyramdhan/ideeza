<template>
  <div class="mt-16 shadow-md categories">
    <!--Search-->
    ...
    <div class>
      ...
      <!-- <div class="main-menu-item" v-for="info in mydata" v-if="info.id == 2">
    ...
    <div class="bg-gray-200 cursor-pointer px-6 py-3">+ Add new category</div>
  </div>
</template>
