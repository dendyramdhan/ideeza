    ...
    <div class="flex-grow mb-20">
      <div class="main-contents">
        ...
        <div class="lg:flex justify-between items-center my-5">
          <nuxt-link to="/technician/management/blogs/add" class="btn btn-normal btn--ideeza px-10 py-4 block lg: inline-block">
...
export default {
  ...
  mounted() {
    ...
    apiService(sendData, response => {
      ...
      let endd =
        this.articleArrayrout.length /
        this.$store.state.TechnicianProjectStore.scale + 1;
      for (i = 1; i <= endd; i++) {
