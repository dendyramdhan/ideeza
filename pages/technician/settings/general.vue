...
<template>
    <div class="mx-auto">
        ...
        <div v-if="userData.id == userid">
            ...
            <div class="my-5 p-5 bg-white shadow-md">
                ...
                <div class="form-field">
                    ...
                    <div class="field-input flex-grow">
                        <input class="field h-10" name="name" :value="userData.firstname" @change="changefirstname" />
                    </div>
                </div>
                <div class="form-field">
                    ...
                    <div class="field-input flex-grow">
                        <input class="field h-10" :value="userData.email" @change="changeemail" />
                    </div>
                </div>
                <div class="form-field">
                    <div class="field-label">
                    ...
                    <div class="field-input flex-grow">
                        <input class="field h-10" :value="userData.phone" @change="changephonenumber" />
                    </div>
                </div>
                <div class="form-field">
                    <div class="field-label">
                    ...
                    <div class="field-input flex-grow">
                        <input class="field h-10" :value="userData.address" @change="changeaddress" />
                    </div>
                </div>
                <div class="form-field">
                    <div class="field-label">Website</div>
                    <div class="field-input flex-grow">
                        <input class="field h-10" :value="userData.website" @change="changewebsite" />
                    </div>
                </div>
                <div class="form-field">
            ...
            <div class="my-5 p-5 bg-white shadow-md">
                ...
                <div class="md:flex">
                    <div class="w-full h-64 mb-5 md:mb-0 md:h-48 md:w-48 md:w-max-content md:mr-6 flex-shrink">
                        <img class="object-cover object-center h-full mx-auto" :src=" avata_img_url + userData.avatar" id="image" />
                    </div>
                    <div class="flex-grow">
                        ...
                        <div class="mt-10">
                            ...
                            <button class="btn pill-button w-full" @click="$refs.file_upload.click()">Upload a file from your computer</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="my-5 p-5 bg-white shadow-md">
                <div class="mb-10">
                    <h1 class="text-lg font-semibold text-gray-600 pb-3 border-b border-solid border-gray-400">Facebook</h1>
                    <div class="lg:flex justify-between">
                        <div class="text-lg text-gray-500 mt-3 pr-0 lg:pr-28">
                            Sign in with Facebook and discover your trusted connections to people all over the world.
                        </div>
                ...
                <div class="mb-10">
                    <h1 class="text-lg font-semibold text-gray-600 pb-3 border-b border-solid border-gray-400">LinkedIn</h1>
                    <div class="lg:flex justify-between">
                        <div class="text-lg text-gray-500 mt-3 pr-0 lg:pr-28">
                            Sign in with Facebook and discover your trusted connections to people all over the world.
                        </div>
...
<script>
    ...
    export default {
        ...
        data: function() {
            return {
                geturl: "/accounts/user-info/",
                userData: [],
                randomNumber: {},
                avata_img_url: process.env.avatar_base_url,
                userData: [],
                userid: null,
                geturl2: "/accounts/user-info/",
                firstname: null,
                lastname: null,
                birthday: null,
                email: null,
        ...
        mounted() {
            ...
            apiService(sendData, response => {
                ...
                this.birthday = this.userData.date_of_birth;
                this.email = this.userData.email;
                this.sex = this.userData.sex;
                this.phone = this.userData.phone;
                this.prefered_language = this.userData.prefered_language;
                this.address = this.userData.address;
                this.website = this.userData.website;
                this.skill = this.userData.skill;
                this.desc = this.userData.desc;
                ...
                this.lineofbusiness = this.userData.lineofbusiness;
                this.expertise = this.userData.expertise;
            });
        },
        methods: {
            changefirstname(evt) {
