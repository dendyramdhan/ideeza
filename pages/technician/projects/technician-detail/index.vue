          ...
          <table class="mt-10 shadow-md">
            <thead>
              <tr class="text-white h16 gradient-bg">
                <th class="text-left ">
                  <font-awesome-icon class="mr-1 text-lg text-black" :icon="['fas', 'sort']" />Tasks</th>
                <th class="text-left">
                  <font-awesome-icon class="mr-1 text-lg text-black" :icon="['fas', 'sort']" />Domain</th>
                <th class="text-left">Assigned to</th>
                <th class="text-left">
                  <font-awesome-icon class="mr-1 text-lg text-black" :icon="['fas', 'sort']" />Due Date</th>
                <th class="text-left">
                  <font-awesome-icon class="mr-1 text-lg text-black" :icon="['fas', 'sort']" />Task Status</th>
