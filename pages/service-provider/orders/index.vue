        ...
        <div class="hidden xl:flex justify-between">
          ...
          <div>
            <div class="flex w-fit-content bg-white justify-center border-light-gray items-center content-center">
              ...
              <input placeholder="Find and order by detail..." class="bg-white outline-none h-8 text-gray-800 pr-3" v-model="searchTerm" v-on:input="search" />
              <!-- <input
          ...
          <tbody v-for="(order, index) in orders">
            <tr class="font-semibold border-b border-gray-500">
              ...
              <td class="text-left">
                ...
                <div>
                  <nuxt-link :to="'/service-provider/orders/'+order.id" class="py-2 px-3 border border-gray-400">Details</nuxt-link>
                </div>
              </td>
            </tr>
          </tbody>
