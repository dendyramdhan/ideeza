            ...
            <div class="md:m-8 lg:m-8 m-2">
                ...
                <div class="max-w-3xl bg-white shadow-lg">
                    <div class="p-8">
                        ...
                        <hr class="mb-2">
                        <div class="form-field">
                            <div class="field-label">Phone Number
                                <font-awesome-icon class="ml-2 text-sm" :icon="['fas', 'lock']" />
                            </div>
                            <div class="field-input flex-grow">
                ...
                <div class="max-w-3xl bg-white shadow-lg">
                    <div class="p-8">
                        <div class="lg:flex md:flex">
                            <img class="object-cover object-center h-full mx-auto" :src=" avata_img_url + articleArraymid1.avatar" id="image" />
            ...
            <div class="md:m-8 lg:m-8 m-2">
                ...
                <div class="max-w-3xl bg-white shadow-lg">
                    <div class="p-8">
                        ...
                        <div class="lg:flex md:flex">
                            <div>
                                <p class="mb-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit.reprehenderit nam, cupiditate ea amet voluptatum similique expedita, quae aut? Fuga, assumenda aperiam.</p>
                            </div>
                            <div class="flex justify-end lg:block md:block">
                                <button class="ml-5 border border-gray-400 px-3 py-1 font-semibold text-gray-500 w-32" @click="disconnectfacebook">Disconnect</button>
                            </div>
                        </div>
                        ...
                        <div class="lg:flex md:flex">
                            ...
                            <div class="flex justify-end lg:block md:block">
                                <button class="ml-5 border border-gray-400 px-3 py-1 font-semibold text-gray-500 w-32" @click="disconnectlinkedin">Disconnect</button>
                            </div>
                        </div>
                        ...
                        <div class="lg:flex md:flex">
                            ...
                            <div class="flex justify-end lg:block md:block">
                                <button class="ml-5 border border-gray-400 px-3 py-1 font-semibold text-gray-500 w-32" @click="disconnectgoogle">Disconnect</button>
                            </div>
                        </div>
