        ...
        <tbody class="text-gray-800">
          <tr v-for="(tabledata, index) in articleArray" v-if="start < index && index < end ">
            ...
            <td class="text-gray-500">
              <nuxt-link :to="{ path: '/service-provider/blog/view', query: { id: tabledata.id}}">
                <!-- <nuxt-link to="/service-provider/blog/view"> -->
              ...
              <nuxt-link :to="{ path: '/service-provider/messages', query: { id: tabledata.id}}">
                <font-awesome-icon
                  class="mr-1 h-3 cursor-pointer hover:text-gray-800"
                  :icon="['fas', 'envelope']"
                />
