  ...
  <div :class="{'hide-left-bar':!leftMenu}" class="flex main-panel">
    ...
    <div class="flex-grow">
      <div class="main-contents">
        ...
        <!--FAQ's-->
        <div class="mt-20">
          <h1 class="text-gray-800 lg:text-4xl lg:mt-10 font-semibold pb-5 border-b heading-border">
            Frequently Asked
            Questions
          </h1>
        </div>
        ...
        <div class="faq-container lg:flex flex-wrap">
          <div class="faq-wrapper mt-5">
            <h1
              class="border-b heading-border text-gray-600 lg:text-xl lg:mt-10 font-semibold pb-5"
            >Shipping</h1>
            <p>
              Lorem ipsum dolores s consectetur
              adipisicing elit, sed do eismod tempor ?
            </p>
            <p>Sed do eiusmod temporis as alasto ?</p>
            <p>
