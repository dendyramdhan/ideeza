        ...
        <div class="mt-10 lg:flex welcome-container">
          <div class="lg:w-1/2 lg:h-full relative text-white">
            ...
            <div class="absolute top-0 left-0 w-full text-center flex flex-col items-center">
              <h1 class="font-semibold lg:text-5xl mt-10 mb-5 text-black text-center w-full">Let's get you started</h1>
              <span class="font-semibold block text-3xl mb-3 w-full text-black text-center">Now is your time to change the world.</span>
              <span class="font-semibold block text-3xl mb-3 w-full text-black text-center">Dream, invent, create.</span>
          ...
          <div class="lg:w-1/2 md:pl-10">
            <div class="md:flex justify-between">
              <nuxt-link to="/user/projects" class="flex-1">
                <div class="status-button p-2">
                  <div class="flex items-center">
                    ...
                    <span class="text-3xl font-bold text-ideeza-black mb-5 leading-none">{{lengthofprojects}}</span>
                  </div>
                  <div class="pl-12">
              ...
              <nuxt-link to="/user/profile?tab=friends" class="flex-1">
                <div class="status-button p-2">
                  <div class="flex items-center">
                    ...
                    <span class="text-3xl font-bold text-ideeza-black mb-5 leading-none">{{activities.contactsmark}}</span>
                  </div>
                  <div class="pl-12">
              ...
              <nuxt-link to="/user/dashboard" class="flex-1">
                <div class="status-button p-2">
                  <div class="flex items-center">
                    ...
                    <span class="text-3xl font-bold text-ideeza-black mb-5 leading-none">{{activities.myscore}}</span>
                  </div>
                  <div class="pl-12">
              ...
              <div class="flex-1">
                <span class="score-badge rookieColor" :class="{'opacity-1': activities.myscore >= 0 &&  activities.myscore <=100}">Rookie</span>
                <span class="score-badge talentedColor" :class="{'opacity-1': activities.myscore >= 101 &&  activities.myscore <=500}">Talented</span>
                <span class="score-badge seniorColor" :class="{'opacity-1': activities.myscore >= 501 &&  activities.myscore <=1000}">Senior</span>
                <span class="score-badge masterColor" :class="{'opacity-1':activities.myscore > 1000}" v-show="activities.myscore >= 1001">Master</span>
              </div>
            </div>
            <div class="md:flex justify-between items-center pb-5 mt-6 border-b border-light-gray">
              ...
              <nuxt-link to="/user/profile?tab=activities" class="btn pill-button px-10 text-lg" tag="button">View all activities</nuxt-link>
            </div>
                    ...
                    <div class="blog-container md:w-1/3" v-for="(innovation,index) in chunk">
                      <template v-if="index==1">
                        <div class="m-1">
                          ...
                          <nuxt-link to>
                            <div class="mb-8">
                              <img :src="blog_post_url + innovation.postimage" class="object-center object-contain" alt style="height: 200px" />
                            </div>
                          </nuxt-link>
                        </div>
                      </template>
                  ...
                  <div class="w-1/2 p-2" v-for="topproject in topprojects">
                    <nuxt-link tag="div" :to="{ path: '/user/projects/detail', query: { id: topproject.project_info.project_id}}" class="p-2 border border-solid border-light-gray bg-white cursor-pointer">
                      <div class="w-full relative projects-image">
                        <img :src="project_image_url + topproject.project_info.image" class="object-contain object-center w-full" alt />
                      ...
                      <div class="flex items-center" style="cursor: pointer">
                        <img class="h-10 w-10 rounded-full mr-2" src="https://randomuser.me/api/portraits/men/21.jpg" />
