<template>
  <div class="settings-transaction-history mx-auto">
    ...
    >
      <h1 class="text-gray-800 text-xl lg:text-3xl font-semibold">My Oasdfasdfrders</h1>
    </div>
    ...
    <div class="my-5 p-5 bg-white shadow-md">
          ...
          <tr>
            <td class="product">
              <div class="lg:flex">
                ...
                <div>
                  <span class="block font-semibold">Lamborghini Aventado Project</span>
                  <span class="block text-sm text-gray-500">
                    Electronics + Cover
                  </span>
                  <span class="text-sm block mt-3">Order ID:  1123123</span>
                </div>
              </div>
            </td>
            <td class="lg:text-center">12</td>
            <td class="font-semibold">1 month</td>
            ...
            <td class="font-semibold">
              ...
              <span class="text-sm text-gray-500 block">Electronics:</span>
              <span class="font-semibold block">PCB Way</span>
            ...
            <td class="font-semibold">
              ...
              <span class="font-semibold block">In progress</span>
              <span class="text-sm text-gray-500 block">Order Time and Date:</span>
              <span class="font-semibold block">12/11/2018</span>
            </td>
      ...
      <div class="w-6/12 p-4 m-auto bg-white shadow fixed z-50 top-0 left-0 right-0 m-auto mt-24" style="max-height:80%;overflow:auto">
         <div class="flex relative">
          <img src="~/static/images/comments.png" class="mr-3">
           <h2 class="text-2xl font-bold text-gray-800">Dispute: </h2>
           <div class="text-gray-600 absolute top-0 right-0">2/2</div>
         </div>
         
        <div class="w-2/3">
           <p class="text-lg text-gray-800 py-3">2. Please tell us your solution
           </p>
           <p class="text-lg text-gray-600 py-3">Order Total: US $ 5.75 ( US $ 5.75 Product Price and US $ 0.0 Shipping Fee)</p>

           <div class="pl-3">
             <p class="text-lg text-gray-600 py-3">Your Refund Request:</p>
             <p>
              <input type="radio" id="radB1" name="radio-group1" checked>
              <label for="radB1">Full refund</label>
            </p>
          ...
          <div class="pl-3">
            ...
            <p class="text-lg text-gray-800 py-3 ">Please write your request detail:</p>
            <div class="mb-4">
              <textarea class="shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="" type="text" placeholder="Please provide clear reasons for your refund (between 5-512 characters)..." rows="6"></textarea>
            </div>


            <p class="py-2">
              <label>Please Upload Attachments:</label>

              <div class="upload-btn-wrapper mb-4">
                <button class="block mt-4 bg-white text-gray-800 border border-gray-400  py-2 px-4 rounded focus:outline-none focus:shadow-outline text-left"><font-awesome-icon class=" text-ideeza text-xl" :icon="['fas', 'cloud-upload-alt']"/> Add File  </button>
                <input type="file" name="myfile" />
              </div>
            </p>
             
          </div>
          <div class="border-t flex justify-between py-6 mt-5">
            <button class="bg-white text-gray-700 border border-gray-700 rounded py-2 px-5">Cancel</button>
            <button class="bg-ideeza border text-white rounded py-3 px-6">Submit</button>
          </div>
