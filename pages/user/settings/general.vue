  ...
  <div class="settings-general mx-auto">
    ...
    <div class="my-5 p-5 bg-white shadow-md">
      ...
      <div class="form-field">
        ...
        <div class="field-input flex-grow">
          <textarea class="field h-20"></textarea>
        </div>
      </div>
    ...
    <div class="my-5 p-5 bg-white shadow-md">
      ...
      <div class="md:flex">
        ...
        <div class="flex-grow">
          ...
          >First impressions count, we all know this. And we only get one chance to make a good first impression. Perhaps in person, your charm and use of language can camouflage your faults, but in the online world. your first impression is made with your face – your profile picture.</div>
          <div class="mt-10">
              <button class="btn pill-button w-full" @click="upload">Upload a file from your computer</button>            
          </div>
        </div>
      </div>
    </div>
