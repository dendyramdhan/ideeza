  ...
  <div class="main-contents">
    ...
    <div class="p-0 lg:py-10 lg:pl-10">
          ...
          <div class="lg:flex">
            ...
            <div>
              <div class="lg:flex flex-wrap items-center mt-5 lg:mt-0">
                <h1 class="lg:text-5xl font-semibold text-gray-800 lg:mr-2 leading-none">{{descrition.article}}</h1>
              </div>
              <div class="lg:my-10 my-3 flex items-center">
                <div v-for="index in  descrition.rating" :key="index">
                  <font-awesome-icon class="mr-1 h-10 lg:text-2xl cursor-pointer text-yellow-600" :icon="['fas', 'star']" />
                </div>
      ...
      <div v-else-if="this.$store.state.userBlogStore.viewflag == 2" class="lg:flex">
        ...
        <div>
          <div class="lg:flex flex-wrap items-center mt-5 lg:mt-0">
            <h1 class="lg:text-5xl font-semibold text-gray-800 lg:mr-2 leading-none"> {{window.$nuxt.$cookies.get("blogcategoryna")}}</h1>
            <!-- {{this.$store.state.userBlogStore.viewflag}} -->
          </div>
          <div class="lg:my-10 my-3 flex items-center">
            <img class="h-12 w-12 mr-5 rounded-full" src="https://randomuser.me/api/portraits/women/14.jpg" />
            <span class="text-gray-800 font-semibold text-xl"> {{window.$nuxt.$cookies.get("blogarticlename")}}</span>
          </div>
          <p class="text-base lg:text-lg">
